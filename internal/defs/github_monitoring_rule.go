...
func (r *MonitoringRule) GetCheckInactivity() bool {
	return r.CheckInactivity
}

func (r *MonitoringRule) SetCheckInactivity(check bool) {
	r.CheckInactivity = check
}

func (r *MonitoringRule) GetInactiveDaysThreshold() int {
	return r.InactiveDaysThreshold
}

func (r *MonitoringRule) SetInactiveDaysThreshold(days int) {
	r.InactiveDaysThreshold = days
}

func (r *MonitoringRule) GetMonitorPRs() bool {
	return r.MonitorPRs
}

func (r *MonitoringRule) SetMonitorPRs(monitor bool) {
	r.MonitorPRs = monitor
}

func (r *MonitoringRule) GetRuleName() string {
	return "monitoring"
}

func (r *MonitoringRule) SetRuleName(name string) {
	// No-op for monitoring rule
}
