...
func (r *Runtime) GetDebug() bool {
	return r.Debug
}

func (r *Runtime) GetDryRun() bool {
	return r.DryRun
}

func (r *Runtime) GetReportDir() string {
	return r.ReportDir
}
...
func (r *Runtime) SetDryRun(dryRun bool) {
	r.DryRun = dryRun
}

func (r *Runtime) SetReportDir(reportDir string) {
